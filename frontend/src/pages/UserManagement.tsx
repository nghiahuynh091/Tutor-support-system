...
type User = {
  ...
  role:
    ...
    | "student_affairs";
  joinDate: string;
  // Enhanced profile data from API
  phone?: string;
  bio?: string;
  faculty?: string;
  mentee_major?: string;
            ...
            <Card className="border-blue-200">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  User Accounts ({totalUsers} total, showing {users.length}{" "}
                  users)
                </CardTitle>
              </CardHeader>
              <CardContent>
                        ...
                        >
                          {selectedUser.role
                            ? selectedUser.role.charAt(0).toUpperCase() +
                              selectedUser.role.slice(1).replace(/_/g, " ")
                            : "Unknown"}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 bg-gray-50 p-4 rounded-lg">
                      ...
                      {selectedUser.bio && (
                        <div className="flex items-start gap-3">
                          <BookOpen className="h-4 w-4 text-gray-600 mt-1" />
                          <div>
                          ...
                          {selectedUser.coursesEnrolled && (
                            <div>
                              ...
                              <div className="text-lg font-bold text-blue-600">
                                {selectedUser.coursesEnrolled.length}
                              </div>
                            </div>
                          )}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <div className="text-lg font-bold text-green-600">
                                  {selectedUser.completedSessions || 0}
                                </div>
                              </div>
                            </div>
                          )}
