...
export function RoleSelectionPage() {
  ...
  const handleRoleSelect = (role: "mentee" | "tutor" | "admin") => {
    setCurrentRole(role);
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">
            Welcome back, {user?.full_name || "User"}! Choose how you'd like to
            continue.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Access your classes, view schedules, and track your learning
                  progress.
                </p>
                <Button
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Manage your classes, create sessions, and support your
                  mentees.
                </p>
                <Button
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Oversee the system, manage conflicts, and monitor overall
                  progress.
                </p>
                <Button
